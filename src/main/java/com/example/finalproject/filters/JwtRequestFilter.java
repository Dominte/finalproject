...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    @Autowired
    public JwtRequestFilter(JwtTokenUtil jwtTokenUtil, UserServiceSecurity userServiceSecurity) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        if (!request.getServletPath().equals("/v1/user/login")) {
            ...
            if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                UserDetails userDetails = this.userServiceSecurity.loadUserByUsername(username);
